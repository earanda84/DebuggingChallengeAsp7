...
using DebuggingChallengeAsp7.Models;

namespace DebuggingChallengeAsp7.Controllers;
...
public class HomeController : Controller
{
    ...
    {
        // Evalúa si existe la session para Name, pero se declara una session con UserName
    ...
    {
        // // Se invoca a la funcion GeneratePassCode()
        GeneratePasscode();
        return RedirectToAction("Generator");
    }
